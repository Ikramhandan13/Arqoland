...
public class Queries {
    ...
    public static final String CREATE_MEMBERS_TABLE = "CREATE TABLE IF NOT EXISTS arqoland_members (land_id INT NOT NULL, player_uuid VARCHAR(36) NOT NULL, role VARCHAR(16) NOT NULL, total_contributed INT DEFAULT 0, PRIMARY KEY (land_id, player_uuid), FOREIGN KEY (land_id) REFERENCES arqoland_lands(id) ON DELETE CASCADE);";

    public static final String CREATE_ALLIANCES_TABLE = "CREATE TABLE IF NOT EXISTS arqoland_alliances (land_id INT NOT NULL, ally_land_id INT NOT NULL, PRIMARY KEY (land_id, ally_land_id), FOREIGN KEY (land_id) REFERENCES arqoland_lands(id) ON DELETE CASCADE, FOREIGN KEY (ally_land_id) REFERENCES arqoland_lands(id) ON DELETE CASCADE);";

    public static final String CREATE_ENEMIES_TABLE = "CREATE TABLE IF NOT EXISTS arqoland_enemies (land_id INT NOT NULL, enemy_land_id INT NOT NULL, PRIMARY KEY (land_id, enemy_land_id), FOREIGN KEY (land_id) REFERENCES arqoland_lands(id) ON DELETE CASCADE, FOREIGN KEY (enemy_land_id) REFERENCES arqoland_lands(id) ON DELETE CASCADE);";
    
    public static final String CREATE_TURRETS_TABLE = "CREATE TABLE IF NOT EXISTS arqoland_turrets (land_id INT NOT NULL, world VARCHAR(32) NOT NULL, x INT NOT NULL, y INT NOT NULL, z INT NOT NULL, PRIMARY KEY (world, x, y, z), FOREIGN KEY (land_id) REFERENCES arqoland_lands(id) ON DELETE CASCADE);";
    ...
    public static final String DELETE_TURRET = "DELETE FROM arqoland_turrets WHERE world = ? AND x = ? AND y = ? AND z = ?;";
    public static final String LOAD_LAND_TURRETS = "SELECT world, x, y, z FROM arqoland_turrets WHERE land_id = ?;";
    ...
    public static final String INSERT_ALLY = "INSERT INTO arqoland_alliances (land_id, ally_land_id) VALUES (?, ?);";
    public static final String DELETE_ALLY = "DELETE FROM arqoland_alliances WHERE (land_id = ? AND ally_land_id = ?) OR (land_id = ? AND ally_land_id = ?);";

    public static final String INSERT_ENEMY = "INSERT INTO arqoland_enemies (land_id, enemy_land_id) VALUES (?, ?);";
    public static final String DELETE_ENEMY = "DELETE FROM arqoland_enemies WHERE land_id = ? AND enemy_land_id = ?;";
    ...
    public static final String LOAD_LAND_ENEMIES = "SELECT enemy_land_id FROM arqoland_enemies WHERE land_id = ?;";
    
    public static final String DELETE_INACTIVE_LANDS = "DELETE FROM arqoland_lands WHERE last_active < ?;";
