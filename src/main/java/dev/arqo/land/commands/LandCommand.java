...
public class LandCommand {
    ...
    public void help(CommandSender sender) {
        sender.sendMessage("§e=== ArqoLand Enterprise Perintah ===");

        sender.sendMessage("§f/al claimland <nama> §7- Klaim wilayah");
        sender.sendMessage("§f/al status [land] §7- Info wilayah & brankas");
        sender.sendMessage("§f/al displayname <nama> [-c <warna>] §7- Ganti nama tampilan");
        sender.sendMessage("§f/al addmember <player> §7- Tambah anggota");
        sender.sendMessage("§f/al kickmember <player> §7- Tendang anggota");
        sender.sendMessage("§f/al promote/demote <player> §7- Atur role");
        sender.sendMessage("§f/al pvp <on/off> §7- Toggle PvP");
        sender.sendMessage("§f/al ally <land> §7- Kirim permintaan aliansi");
        sender.sendMessage("§f/al allyaccept <land> §7- Terima aliansi");
        sender.sendMessage("§f/al allyout <land> §7- Keluar dari aliansi");
        sender.sendMessage("§f/al spawn [land] §7- Teleport (Member Only)");
        sender.sendMessage("§f/al topbrankas/topsetoran §7- Leaderboard");
    }
